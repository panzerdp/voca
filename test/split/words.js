...
describe('words', function() {
  it('should split the string into words', function() {
    ...
    expect(v.words('gravity can cross dimensions')).toEqual([
      'gravity',
      'can',
      'cross',
      'dimensions'
    ...
    expect(v.words('gravity_can_cross_dimensions')).toEqual([
      'gravity',
      'can',
      'cross',
      'dimensions'
    ...
    expect(v.words('GravityCanCrossDimensions')).toEqual([
      'Gravity',
      'Can',
      'Cross',
      'Dimensions'
    ...
    expect(v.words('Cooper... Cooper... Come in, Cooper.')).toEqual([
      'Cooper',
      'Cooper',
      'Come',
      'in',
    ...
    expect(v.words("Newton's third law")).toEqual([
      'Newton',
      's',
      'third',
      'law'
    ...
    expect(v.words('foo\u0303\u035C\u035D\u035E bar')).toEqual([
      'foo\u0303\u035C\u035D\u035E',
      'bar'
    ]);
    expect(v.words('fo-O-O\u0303\u035C\u035D\u035E-bar')).toEqual([
      'fo',
      'O',
      'O\u0303\u035C\u035D\u035E',
      'bar'
  ...
  it('should split the string with diacritics into words', function() {
    expect(v.words('clasificación biológica.')).toEqual([
      'clasificación',
      'biológica'
    ]);
    ...
    expect(v.words('Гравитация притягивает все')).toEqual([
      'Гравитация',
      'притягивает',
      'все'
    ]);
    ...
    expect(v.words('Στις--αρχές** (του) 21ου, αιώνα!')).toEqual([
      'Στις',
      'αρχές',
      'του',
      '21',
  ...
  it('should split the string into words using a pattern', function() {
    expect(v.words('1234567890', /\d/g)).toEqual([
      '1',
      '2',
      '3',
      '4',
    ...
    expect(
      v.words('gravity can cross dimensions', '\\w+(?=\\s?)', 'g')
    ).toEqual(['gravity', 'can', 'cross', 'dimensions']);
    expect(v.words('1234567890', /\s/g)).toEqual([]);
  });

  it('should split the string with default pattern for null and undefined', function() {
    expect(v.words('gravity_can_cross_dimensions', null)).toEqual([
      'gravity',
      'can',
      'cross',
      'dimensions'
    ]);
    expect(v.words('gravity_can_cross_dimensions', undefined)).toEqual([
      'gravity',
      'can',
      'cross',
      'dimensions'
