...
export default function(character) {
  if (diacritics !== null) {
    return diacritics[character];
  }
  /**
   * Create the diacritics map
  ...
  for (var index = 0; index < defaultDiacriticsRemovalMap.length; index++) {
    var letters = defaultDiacriticsRemovalMap[index].letters;
    for (var letterIndex = 0; letterIndex < letters.length; letterIndex++) {
      diacriticsMap[letters[letterIndex]] = defaultDiacriticsRemovalMap[index].base;
    }
  }
