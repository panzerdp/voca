 ...
 * @ignore
 */
export const REGEXP_COMBINING_MARKS = new RegExp('([\\0-\\u02FF\\u0370-\\u1AAF\\u1B00-\\u1DBF\\u1E00-\\u20CF\\u2100-\\uD7FF\\uE000-\\uFE1F\\uFE30-\\uFFFF]|[' + highSurrogate + '][' + lowSurrogate + ']|[' + highSurrogate + '](?![' + lowSurrogate + '])|(?:[^' + highSurrogate + ']|^)[' + lowSurrogate + '])([' + diacriticalMark + ']+)', 'g');
 ...
 * @ignore
 */
export const REGEXP_ALPHA = new RegExp('^(?:[^' + nonLetter + '][' + diacriticalMark + ']*)+$');
 ...
 * @ignore
 */
export const REGEXP_ALPHA_DIGIT = new RegExp('^((?:[^' + nonLetter + '][' + diacriticalMark + ']*)|[' + digit + '])+$');
 ...
 * @ignore
 */
export const REGEXP_NON_BASIC_LATIN = /[^\u0000-\u007E]/g;
 ...
 * @ignore
 */
export const REGEXP_SPECIAL_CHARACTERS = /[-[\]{}()*+!<=:?.\/\\^$|#\s,]/g;
 ...
 * @ignore
 */
const lowerCaseLetterClass = '(?![' + upLetter + '])[^' + nonLetter + ']';
 ...
 * @ignore
 */
export const REGEXP_NON_LATIN = /[\W]/g;
 ...
 * @ignore
 */
export const REGEXP_LATIN = /^[\x00-\xFF]*$/;
