...
!(function(e, r) {
    ...
    return (e =
      ...
      function(e) {
        for (let r = 1; r < arguments.length; r++) {
          let n = arguments[r];
          for (let u in n) Object.prototype.hasOwnProperty.call(n, u) && (e[u] = n[u]);
        }
        return e;
  ...
  function n(e) {
    return (
      (function(e) {
        if (Array.isArray(e)) {
          for (let r = 0, n = new Array(e.length); r < e.length; r++) n[r] = e[r];
          return n;
        }
      })(e) ||
      (function(e) {
  ...
  function g(e, r) {
    let n = 1 < arguments.length && void 0 !== r && r;
  ...
  let Y = 55296,
    ...
    J = 57343;
  function q(e, r) {
    let n = 1 < arguments.length && void 0 !== r ? r : 0;
  ...
  let ee = 'i',
    ...
    xe = 16;
  function ye(e, r) {
    for (let n = F(e), u = h(r) ? 1 : T(V(r), 0, Z), t = ''; u; ) 1 & u && (t += n), 1 < u && (n += n), (u >>= 1);
    return t;
  }
  function Fe(e, r) {
  ...
  let Ge = Array.prototype.reduceRight;
  function He(e, r) {
    var n = F(e);
    if ('' === r || '' === n) return n;
    let u = z(r);
