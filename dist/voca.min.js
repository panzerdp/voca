...
!(function(e, r) {
    ...
    return (e =
      ...
      function(e) {
        for (let r = 1; r < arguments.length; r++) {
          const n = arguments[r];
          for (const u in n) Object.prototype.hasOwnProperty.call(n, u) && (e[u] = n[u]);
        }
        return e;
  ...
  function g(e, r) {
    const n = 1 < arguments.length && void 0 !== r && r;
  ...
  const a = '\\uD800-\\uDBFF';
  const o = '\\uDC00-\\uDFFF';
  const c = '\\u0300-\\u036F\\u1AB0-\\u1AFF\\u1DC0-\\u1DFF\\u20D0-\\u20FF\\uFE20-\\uFE2F';
  const f = '\\0-\\u02FF\\u0370-\\u1AAF\\u1B00-\\u1DBF\\u1E00-\\u20CF\\u2100-\\uD7FF\\uE000-\\uFE1F\\uFE30-\\uFFFF';
  const s = new RegExp(
    '([' + f + ']|[' + a + '][' + o + ']|[' + a + '](?![' + o + '])|(?:[^' + a + ']|^)[' + o + '])([' + c + ']+)',
    'g'
  );
  const l = new RegExp('([' + a + '])([' + o + '])', 'g');
  const p = new RegExp(
    '((?:[' +
      f +
      ']|[' +
  ...
  const v = new RegExp('[' + t + ']');
  const d = new RegExp('^[' + t + ']+');
  const b = new RegExp('[' + t + ']+$');
  const w = new RegExp('^\\d+$');
  const m = /[-[\]{}()*+!<=:?./\\^$|#,]/g;
  const E = /[^A-Za-z0-9]/g;
  const C = /[<>&"'`]/g;
  const A = /(%{1,2})(?:(\d+)\$)?(\+)?([ 0]|'.{1})?(-)?(\d+)?(?:\.(\d+))?([bcdiouxXeEfgGs])?/g;
  const D = /\.?0+$/g;
  const k = /<([A-Za-z0-9]+)>/g;
  const S =
  ...
  const j = /[A-Z\xC0-\xD6\xD8-\xDE]?[a-z\xDF-\xF6\xF8-\xFF]+|[A-Z\xC0-\xD6\xD8-\xDE]+(?![a-z\xDF-\xF6\xF8-\xFF])|\d+/g;
  const L = new RegExp('^(?:[' + S + O + '][' + c + ']*)+$');
  const R = new RegExp('^((?:[' + S + O + '][' + c + ']*)|[' + r + '])+$');
  const N = /^[\x01-\xFF]*$/;
  function P(e, r) {
    return null == e ? r : e;
  }
  ...
  function W(e, r, n) {
    const u = F(e);
    const t = h(r) ? u.length : T(V(r), 0, Z);
    const i = F(n, '...');
  ...
  const J = 57343;
  function q(e, r) {
    const n = 1 < arguments.length && void 0 !== r ? r : 0;
  ...
  const M = Array.prototype.reduce;
  function Q() {
    this.index = 0;
  }
    ...
    switch (r.typeSpecifier) {
      ...
      case pe:
        n = (function(e, r, n) {
          if (0 === e) return '0';
          const u = 0 === r ? 1 : r;
          let t = e.toPrecision(u).replace(D, '');
  ...
  function Be(e, r, n, u, t, i, a, o, c, f, s) {
    ...
    const p = e.getIndexByPosition(t);
    return (
  ...
  function je(e) {
    ...
    const i = Be.bind(void 0, new Q(), u);
  ...
  function $e(e) {
    const r = (null !== Ue ||
      ...
      Object.keys(Ie).forEach(function(e) {
        for (let r = Ie[e], n = 0; n < r.length; n++) {
          const u = r[n];
          Ue[u] = e;
        }
      })),
  ...
  const We = Array.prototype.reduce;
  function Ye(e, r) {
    const n = F(e);
    if ('' === r || '' === n) return n;
    const u = z(r);
  ...
  const Ge = Array.prototype.reduceRight;
  function He(e, r) {
    const n = F(e);
    if ('' === r || '' === n) return n;
    const u = z(r);
  ...
  const ar = {
    ...
    titleCase: function(e, r) {
      const n = F(e);
      const u = Array.isArray(r) ? r : [];
      const t = N.test(n) ? j : B;
    ...
    search: function(e, r, n) {
      const u = F(e);
      const t = h(n) ? 0 : T(V(n), 0, u.length);
      let i = u.substr(t).search(r);
    ...
    wordWrap: function(e) {
      ...
      const u = F(e);
      const t = { width: q((r = n)[Je], 75), newLine: F(r[qe], '\n'), indent: F(r[Xe], ''), cut: g(r[Ke], !1) };
      const i = t.width;
      const a = t.newLine;
      const o = t.indent;
      const c = t.cut;
    ...
    isNumeric: function(e) {
      const r = 'object' != typeof e || h(e) ? e : Number(e);
    ...
    Object.keys(ar).forEach(function(e) {
      ...
      or.prototype[e] =
        ...
        function() {
          ...
          const u = t.apply(void 0, [this._wrappedValue].concat(r));
